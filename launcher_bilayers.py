"""
launcher_bilayers.py - PyQt6 GUI frontend for CIDeconvolve bilayers.yaml.

Dynamically reads bilayers.yaml and builds a form with appropriate widgets for
...
BILAYERS_PATH = SCRIPT_DIR / "bilayers.yaml"
ICON_PATH = SCRIPT_DIR / "gui" / "icon.svg"
LAST_SETTINGS_PATH = SCRIPT_DIR / ".last_bilayers_settings.json"
...
def load_bilayers_config() -> dict:
    with open(BILAYERS_PATH, "r", encoding="utf-8") as f:
...
def build_docker_command(
    ...
    """Build the docker run command from bilayers.yaml and current values."""
...
class LauncherWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        desc_label = QLabel("Docker launcher generated from bilayers.yaml.")
    ...
    def _on_save_settings(self):
        path, _ = QFileDialog.getSaveFileName(
            self, "Save Settings", str(SCRIPT_DIR / "bilayers_settings.json"),
